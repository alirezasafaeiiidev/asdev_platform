...
bash tests/test_automation_freeze_guard.sh
bash tests/test_codex_automation_manifest.sh
...
bash tests/test_make_hygiene_target.sh
bash tests/test_make_verify_hub_target.sh
bash tests/test_make_verify_target.sh
bash tests/test_run_task_logging.sh
